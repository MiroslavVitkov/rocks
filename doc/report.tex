...
A stimilar study\cite{karkonosze} classifies rock samples form the Karkonosze Mountains via $[\SI{350}{\nano\metre}-\SI{2500}{\nano\metre}]$ spectroscopy.
They acheave a macro averaged accuracy of 76.2\%.
They use a standartised light source instead of laser ablation.
\par
...
$$ \frac{ \mu_1 - \mu_2 } { s^1 + s^2 } $$  % \goesto max
