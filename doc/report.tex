...
\\
When attmepting to classify only by the top 5 basis vectors, the accuracy TODO
...
Does not significantly affect the classifier performance.
However, it has a stabilyzing effect on the svm's inconsistent output.
